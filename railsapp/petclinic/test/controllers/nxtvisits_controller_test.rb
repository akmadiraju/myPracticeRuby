...
class NxtvisitsControllerTest < ActionController::TestCase
  ...
  test "should create nxtvisit" do
    assert_difference('Nxtvisit.count') do
      post :create, nxtvisit: { name: @nxtvisit.name, next_appointment: @nxtvisit.next_appointment, purpose: @nxtvisit.purpose }
    end
  ...
  test "should update nxtvisit" do
    patch :update, id: @nxtvisit, nxtvisit: { name: @nxtvisit.name, next_appointment: @nxtvisit.next_appointment, purpose: @nxtvisit.purpose }
    assert_redirected_to nxtvisit_path(assigns(:nxtvisit))
  end
