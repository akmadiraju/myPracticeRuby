...
class DocsControllerTest < ActionController::TestCase
  ...
  test "should create doc" do
    assert_difference('Doc.count') do
      post :create, doc: { adress: @doc.adress, city: @doc.city, experience: @doc.experience, name: @doc.name, school: @doc.school, state: @doc.state, zip: @doc.zip }
    end
  ...
  test "should update doc" do
    patch :update, id: @doc, doc: { adress: @doc.adress, city: @doc.city, experience: @doc.experience, name: @doc.name, school: @doc.school, state: @doc.state, zip: @doc.zip }
    assert_redirected_to doc_path(assigns(:doc))
  end
